...
const coreAreas = [
  {
    ...
    desc: "Designing systems that handle growth",
  },
  {
    icon: Shield,
    title: "Security First",
    desc: "JWT, encryption & authorization",
  },
  {
    icon: Database,
  ...
  },
  {
    ...
    desc: "Fast, reliable & well-documented",
  },
];
              ...
              <div className="flex flex-col lg:flex-row gap-8 items-start">
                ...
                <div className="flex-1">
                  ...
                  >
                    ...
                    <p>
                      I specialize in API development, database architecture,
                      authentication systems, and backend performance
                      optimization. I have worked on business platforms, admin
                      dashboards, fintech-style systems, church platforms, and
                      enterprise-level applications -- ensuring security,
                      scalability, and maintainability.
                    </p>
                    <p>
                      My development philosophy focuses on{" "}
                      <span className="text-primary font-semibold">
                        clean architecture, efficient data flow, and long-term
                        system reliability
                      </span>
                      .
                    </p>
